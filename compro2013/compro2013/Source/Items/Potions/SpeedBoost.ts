class SpeedBoost extends Item {
    ...
    constructor(x: number, y: number, scene: eg.Rendering.Scene2d, collisionManager: eg.Collision.CollisionManager, items: Item[]) {
        this.name = name;
        this.potionStrength = 100;
        this.using = false;
        super(x, y, "SpeedBoost", scene, new eg.Graphics.ImageSource("Resources/Images/Items/Potions/speedboost.png", 64, 64), collisionManager, items);
    }
