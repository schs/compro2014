class Crossbow extends RangedWeapon {
    ...
    ExecuteAttack() {
        this.projectiles.push(new Projectile(this.sprite.Position.X, this.sprite.Position.Y, this.damage, 10, 10, this.sprite.Rotation, this.knockback, this.scene, new eg.Graphics.ImageSource("/Resources/Images/Items/Weapons/Arrow.png", 64, 64), this.collisionManager));
    }
